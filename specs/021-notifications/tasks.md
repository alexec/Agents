...
- **Open, all hardware:** T074 and T080 (walks), T072's live half is covered by `AttentionTests` US5 against the fake mailbox, and Phase 9 (README, scans, SC measurements) waits on the walks.
