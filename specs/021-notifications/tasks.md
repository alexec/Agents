...
- **C3 walked 2026-09-21, pass** (`abe31b1`); C4 and C6 in hand; C5 struck.
- **Open, all hardware:** T074 (C4, C6) and T080 (walks), T072's live half is covered by `AttentionTests` US5 against the fake mailbox, and Phase 9 (README, scans, SC measurements) waits on the walks.
